...
import com.ecom.models.OrderRequest;
import com.ecom.models.ProductOrder;
import com.ecom.models.UserDtls;
...
public class UserController {
	...
	public String loadCartPage(Principal p, Model m) {
		...
		if (carts.size() > 0) {
			Float totalOrderPrice = carts.get(carts.size() - 1).getTotalOrderPrice();
	...
	public String orderPage(Principal p, Model m) {
		...
		m.addAttribute("carts", carts);
		if (carts.size() > 0) {
			Float orderPrice = carts.get(carts.size() - 1).getTotalOrderPrice();
			Float totalOrderPrice = carts.get(carts.size() - 1).getTotalOrderPrice() + 250 + 100;
